...
<div class="main-header">
    <h1>📘 TRỢ LÝ SOẠN GIÁO ÁN  HỒNG (NLS)</h1>
    <p>Tác giả: Đỗ Thị Hồng - Trường Tiểu học Nhữ Khê - ĐT: 0378 077 222</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đỗ Thị Hồng - Trường Tiểu học Nhữ Khê- ĐT: 0378 077 222</div>", unsafe_allow_html=True)
